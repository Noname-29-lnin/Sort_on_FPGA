...
int main(int argc, char** argv) {
    ...
    results.push_back({"MergeSort", CheckSortedString(Data_MergeSort), Time_Merge, C_Merge.Get_Count_Compare(), C_Merge.Get_Count_Swap(), 0});
    ...
    results.push_back({"Framework_Merge", CheckSortedString(Data_Framework_Merge), Time_Framework_Merge, C_Framework_QuickSort.Get_Count_Compare(), C_Framework_QuickSort.Get_Count_Swap(), 0});
    WriteDataToFile_Dec<DATATPPE_ARR>(Data_Framework_Merge, PATH_SORTED_FILE_1);
