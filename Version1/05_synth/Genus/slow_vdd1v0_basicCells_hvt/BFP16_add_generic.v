...
// Generated on: Dec  9 2025 12:36:03
...
module SHF_left_SIZE_DATA8_SIZE_SHIFT3(i_shift_number, i_data, o_data);
  ...
  wire [7:0] \stage[1] ;
  wire [7:0] \stage[2] ;
  wire n_6, n_16, n_18, n_22, n_87;
  CDN_bmux2 mux_20_33_g2(.sel0 (i_shift_number[0]), .data0 (i_data[6]),
       .data1 (i_data[5]), .z (\stage[1] [6]));
  ...
  CDN_bmux2 g1(.sel0 (i_shift_number[1]), .data0 (\stage[1] [4]),
       .data1 (\stage[1] [2]), .z (n_6));
  CDN_bmux2 g2(.sel0 (i_shift_number[2]), .data0 (n_6), .data1
       (\stage[2] [0]), .z (o_data[4]));
  CDN_bmux2 g3(.sel0 (i_shift_number[1]), .data0 (\stage[1] [6]),
       .data1 (\stage[1] [4]), .z (n_87));
  CDN_bmux2 g4(.sel0 (i_shift_number[2]), .data0 (n_87), .data1
       (\stage[2] [2]), .z (o_data[6]));
  CDN_bmux2 g5(.sel0 (i_shift_number[0]), .data0 (i_data[7]), .data1
       (i_data[6]), .z (n_16));
  CDN_bmux2 g6(.sel0 (i_shift_number[1]), .data0 (n_16), .data1
       (\stage[1] [5]), .z (n_18));
  CDN_bmux2 g7(.sel0 (i_shift_number[2]), .data0 (n_18), .data1
       (\stage[2] [3]), .z (o_data[7]));
  CDN_bmux2 g8(.sel0 (i_shift_number[1]), .data0 (\stage[1] [5]),
       .data1 (\stage[1] [3]), .z (n_22));
  CDN_bmux2 g9(.sel0 (i_shift_number[2]), .data0 (n_22), .data1
       (\stage[2] [1]), .z (o_data[5]));
  and g82 (\stage[1] [0], i_data[0], wc8);
  not gc8 (wc8, i_shift_number[0]);
  and g83 (\stage[2] [1], \stage[1] [1], wc9);
  not gc9 (wc9, i_shift_number[1]);
  and g84 (\stage[2] [0], \stage[1] [0], wc10);
  not gc10 (wc10, i_shift_number[1]);
  and g85 (o_data[3], \stage[2] [3], wc11);
  not gc11 (wc11, i_shift_number[2]);
  and g86 (o_data[2], \stage[2] [2], wc12);
  not gc12 (wc12, i_shift_number[2]);
  and g87 (o_data[1], \stage[2] [1], wc13);
  not gc13 (wc13, i_shift_number[2]);
  and g88 (o_data[0], \stage[2] [0], wc14);
...
module BFP16_add(i_data_a, i_data_b, o_bfu_add);
  ...
  wire UNCONNECTED0, is_b_zero_316, n_91, n_92, n_93, n_94, n_99, n_116;
  wire n_117, n_118, n_119, n_120, n_121, n_122, n_123, n_124;
  wire n_125, n_129, n_130, n_164, n_165, n_180, n_181, n_323;
  wire n_324, n_325, n_326, n_327, n_328, w_alu_man_overflow,
  ...
  not g20 (n_91, w_swap_exp_min[0]);
  not g5 (n_94, w_swap_exp_min[3]);
  not g6 (n_93, w_swap_exp_min[2]);
  not g7 (n_92, w_swap_exp_min[1]);
  CDN_mux3 mux_166_23_g28(.sel0 (n_129), .data0 (w_exp_adjust[7]),
       .sel1 (n_130), .data1 (1'b1), .sel2 (is_b_zero_316), .data2
       (i_data_a[30]), .z (o_bfu_add[30]));
  CDN_mux3 mux_166_23_g33(.sel0 (n_129), .data0 (w_exp_adjust[6]),
       .sel1 (n_130), .data1 (1'b1), .sel2 (is_b_zero_316), .data2
       (i_data_a[29]), .z (o_bfu_add[29]));
  CDN_mux3 mux_166_23_g40(.sel0 (n_129), .data0 (w_exp_adjust[5]),
       .sel1 (n_130), .data1 (1'b1), .sel2 (is_b_zero_316), .data2
       (i_data_a[28]), .z (o_bfu_add[28]));
  CDN_mux3 mux_166_23_g45(.sel0 (n_129), .data0 (w_exp_adjust[4]),
       .sel1 (n_130), .data1 (1'b1), .sel2 (is_b_zero_316), .data2
       (i_data_a[27]), .z (o_bfu_add[27]));
  CDN_mux3 mux_166_23_g52(.sel0 (n_129), .data0 (w_exp_adjust[3]),
       .sel1 (n_130), .data1 (1'b1), .sel2 (is_b_zero_316), .data2
       (i_data_a[26]), .z (o_bfu_add[26]));
  CDN_mux3 mux_166_23_g57(.sel0 (n_129), .data0 (w_exp_adjust[2]),
       .sel1 (n_130), .data1 (1'b1), .sel2 (is_b_zero_316), .data2
       (i_data_a[25]), .z (o_bfu_add[25]));
  CDN_mux3 mux_166_23_g64(.sel0 (n_129), .data0 (w_exp_adjust[1]),
       .sel1 (n_130), .data1 (1'b1), .sel2 (is_b_zero_316), .data2
       (i_data_a[24]), .z (o_bfu_add[24]));
  CDN_mux3 mux_166_23_g69(.sel0 (n_129), .data0 (w_exp_adjust[0]),
       .sel1 (n_130), .data1 (1'b1), .sel2 (is_b_zero_316), .data2
       (i_data_a[23]), .z (o_bfu_add[23]));
  CDN_mux4 mux_169_23_g79(.sel0 (n_180), .data0 (w_nor_man[6]), .sel1
       (n_164), .data1 (1'b0), .sel2 (n_165), .data2 (1'b1), .sel3
       (is_b_zero_316), .data3 (i_data_a[22]), .z (o_bfu_add[22]));
  CDN_mux3 mux_169_23_g86(.sel0 (n_180), .data0 (w_nor_man[5]), .sel1
       (n_181), .data1 (1'b0), .sel2 (is_b_zero_316), .data2
       (i_data_a[21]), .z (o_bfu_add[21]));
  CDN_mux3 mux_169_23_g92(.sel0 (n_180), .data0 (w_nor_man[4]), .sel1
       (n_181), .data1 (1'b0), .sel2 (is_b_zero_316), .data2
       (i_data_a[20]), .z (o_bfu_add[20]));
  CDN_mux3 mux_169_23_g98(.sel0 (n_180), .data0 (w_nor_man[3]), .sel1
       (n_181), .data1 (1'b0), .sel2 (is_b_zero_316), .data2
       (i_data_a[19]), .z (o_bfu_add[19]));
  CDN_mux3 mux_169_23_g104(.sel0 (n_180), .data0 (w_nor_man[2]), .sel1
       (n_181), .data1 (1'b0), .sel2 (is_b_zero_316), .data2
       (i_data_a[18]), .z (o_bfu_add[18]));
  CDN_mux3 mux_169_23_g110(.sel0 (n_180), .data0 (w_nor_man[1]), .sel1
       (n_181), .data1 (1'b0), .sel2 (is_b_zero_316), .data2
       (i_data_a[17]), .z (o_bfu_add[17]));
  CDN_mux3 mux_169_23_g116(.sel0 (n_180), .data0 (w_nor_man[0]), .sel1
       (n_181), .data1 (1'b0), .sel2 (is_b_zero_316), .data2
       (i_data_a[16]), .z (o_bfu_add[16]));
  nor g17 (is_b_zero_316, n_124, n_125);
  nand g15 (n_125, n_116, n_117, n_118, n_119);
  nand g16 (n_124, n_120, n_121, n_122, n_123);
  nor g14 (n_123, i_data_b[3], i_data_b[2], i_data_b[1], i_data_b[0]);
  nor g13 (n_122, i_data_b[7], i_data_b[6], i_data_b[5], i_data_b[4]);
  nor g12 (n_121, i_data_b[11], i_data_b[10], i_data_b[9], i_data_b[8]);
  nor g11 (n_120, i_data_b[15], i_data_b[14], i_data_b[13],
       i_data_b[12]);
  nor g10 (n_119, i_data_b[19], i_data_b[18], i_data_b[17],
       i_data_b[16]);
  nor g9 (n_118, i_data_b[23], i_data_b[22], i_data_b[21],
       i_data_b[20]);
  nor g8 (n_117, i_data_b[27], i_data_b[26], i_data_b[25],
       i_data_b[24]);
  nor g1 (n_116, i_data_b[31], i_data_b[30], i_data_b[29],
       i_data_b[28]);
  nor g119 (n_129, is_b_zero_316, w_sel_exp);
  nor g121 (n_180, is_b_zero_316, w_sel_man[1]);
  not g155 (n_323, w_sel_exp);
  not g156 (n_324, w_sel_man[1]);
  not g157 (n_325, w_comp_man_less);
  not g158 (n_326, w_comp_exp_less);
  not g159 (n_327, w_sel_man[0]);
  nand g160 (n_99, n_326, n_325);
  nor g161 (n_130, n_323, is_b_zero_316);
  nor g162 (n_181, n_324, is_b_zero_316);
  not g163 (n_328, n_181);
  nor g164 (n_164, w_sel_man[0], n_328);
  nor g165 (n_165, n_327, n_328);
  and g166 (o_bfu_add[13], is_b_zero_316, i_data_a[13]);
  and g167 (o_bfu_add[12], is_b_zero_316, i_data_a[12]);
  and g168 (o_bfu_add[11], is_b_zero_316, i_data_a[11]);
  and g169 (o_bfu_add[10], is_b_zero_316, i_data_a[10]);
  and g170 (o_bfu_add[9], is_b_zero_316, i_data_a[9]);
  and g171 (o_bfu_add[8], is_b_zero_316, i_data_a[8]);
  and g172 (o_bfu_add[7], is_b_zero_316, i_data_a[7]);
  and g173 (o_bfu_add[6], is_b_zero_316, i_data_a[6]);
  and g174 (o_bfu_add[5], is_b_zero_316, i_data_a[5]);
  and g175 (o_bfu_add[4], is_b_zero_316, i_data_a[4]);
  and g176 (o_bfu_add[3], is_b_zero_316, i_data_a[3]);
  and g177 (o_bfu_add[2], is_b_zero_316, i_data_a[2]);
  and g178 (o_bfu_add[1], is_b_zero_316, i_data_a[1]);
  and g179 (o_bfu_add[0], is_b_zero_316, i_data_a[0]);
  and g180 (o_bfu_add[15], is_b_zero_316, i_data_a[15]);
  and g181 (o_bfu_add[14], is_b_zero_316, i_data_a[14]);
endmodule
