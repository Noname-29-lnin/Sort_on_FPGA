...
// Generated on: Dec  9 2025 12:36:02
...
module BFP16_add(i_data_a, i_data_b, o_bfu_add);
  ...
  wire UNCONNECTED0, is_b_zero, n_59, n_83, n_84, n_85, n_86, n_87;
  wire n_88, n_89, n_90, n_91, n_92, n_93, n_94, n_95;
  wire n_96, n_97, n_98, n_99, n_116, n_117, n_118, n_119;
  wire n_120, n_121, n_122, n_123, n_124, n_125, w_alu_man_overflow,
       w_comp_exp_less;
  ...
  CLA_8bit SUB_EXP_UNIT(.i_carry (1'b1), .i_data_a (w_swap_exp_max),
       .i_data_b ({n_98, n_97, n_96, n_95, n_94, n_93, n_92, n_91}),
  ...
  PSC_unit PSC_UNIT(.i_sign_a (i_data_a[31]), .i_exp_a
       ...
       (w_sel_man));
  not_op_6 g2(.A (w_swap_exp_min), .Z ({n_98, n_97, n_96, n_95, n_94,
       n_93, n_92, n_91}));
  bmux_7 mux_167_39(.ctl (w_sel_man[0]), .in_0 (1'b0), .in_1 (1'b1), .z
       (n_59));
  bmux mux_167_23(.ctl (w_sel_man[1]), .in_0 (w_nor_man), .in_1 ({1'b1,
       n_59, 6'b000000}), .z (w_man_result));
  bmux_20 mux_169_23(.ctl (is_b_zero), .in_0 ({w_man_result[6:0],
       16'b0000000000000000}), .in_1 (i_data_a[22:0]), .z
       (o_bfu_add[22:0]));
  bmux mux_166_46(.ctl (w_sel_exp), .in_0 (w_exp_adjust), .in_1
       (8'b11111111), .z ({n_90, n_89, n_88, n_87, n_86, n_85, n_84,
       n_83}));
  bmux mux_166_23(.ctl (is_b_zero), .in_0 ({n_90, n_89, n_88, n_87,
       n_86, n_85, n_84, n_83}), .in_1 (i_data_a[30:23]), .z
       (o_bfu_add[30:23]));
  or g3 (n_99, w_comp_exp_less, w_comp_man_less);
