...
\begin{lstlisting}[style=StyleResult, language=Result, basicstyle=\fontsize{5}{6}\selectfont\ttfamily, caption={Kết quả kiểm chứng khi chạy với $N = 2^{16}$.}]
	Finished reading file: ./tools/unsorted.txt
	Finish write file './Reports/COMPILE_REPORT/unsorted.txt'.
	Size of array: 65536
	Number subarry M = 4
	Finish write file './Reports/COMPILE_REPORT/sorted.txt'.
	Finish write file './Reports/COMPILE_REPORT/sorted_RTL.txt'.
	
	Sort algorithm                Check sorted   Time (ns)           Number Swap         Number Compare      Auxiliary Space (Bytes)
	-----------------------------------------------------------------------------------------------------------------------------
	Data Set                      FAIL           0                   0                   0                   0                   
	-----------------------------------------------------------------------------------------------------------------------------
	QuickSort                     PASS           4287727             1207637             574041              0                   
	-----------------------------------------------------------------------------------------------------------------------------
	MergeSort                     PASS           4108814             1207637             574041              0                   
	-----------------------------------------------------------------------------------------------------------------------------
	Framework_QuickSort           PASS           5341528             48326879            24038182            0                   
	-----------------------------------------------------------------------------------------------------------------------------
	Framework_Merge               PASS           4993397             142075339           70640897            0                   
	-----------------------------------------------------------------------------------------------------------------------------
	
\end{lstlisting}

\begin{lstlisting}[style=StyleResult, language=Result, basicstyle=\fontsize{9}{10}\selectfont\ttfamily]
	    KB
	85.27^                                                                    :   
	|                                                             @: #:::::: 
	|                                                             @::#:::::: 
